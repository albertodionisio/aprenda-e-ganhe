...
async function ensureExtraQuestions() {
    ...
    try {
        ...
        const extraQuestions = [
            ...
            ['tecnologia', 'A Rosa quer proteger melhor a conta do banco online. Qual destas opções aumenta mais a segurança?', 'Usar sempre a mesma senha simples', 'Ativar a autenticação de dois fatores (2FA)', 'Partilhar a senha com o suporte técnico por telefone', 'Desativar todas as notificações da app', 'B', 'A autenticação de dois fatores (2FA) adiciona uma camada extra de proteção à conta.'],
